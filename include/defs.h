...
constexpr uint_t SORTER_MEM = 2048 * IntScale::Mi; // default bytes used for internal storage of  sorter
constexpr uint_t PQ_INT_MEM = 512 * IntScale::Mi; // default bytes used for internal storage of a PQ
constexpr uint_t PQ_POOL_MEM = 512 * IntScale::Mi; // default bytes used for internal storage of a PQ
